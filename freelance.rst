...
Freelance Consulting Story
==========================

:Authors: Wayne Witzel III, NakedTech LLC
:Date: 01 Jan 1970

..  footer:: Wayne Witzel III, NakedTech LLC

Who Am I
--------

- Python developer, currently working for Geek.net on their SourceForge
  platform.

- A former consultant, at one time, working with 10 different clients
  including Geek.net, CBS Interactive, Rackspace, Lionbridge, and CKAN.

- I do my best to try and give back to the OSS community through very minor
  contributions to SQLalchemy, Pyramid, and the Pylons project.

How This All Started
--------------------

- Disenfranchised with my current job.

- Control what I worked on.
